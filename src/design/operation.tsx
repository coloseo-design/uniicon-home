    ...
    <div className='left'>
      ...
      <div className='btn'>
        <div style={{ flex: 1, marginTop: 8, marginLeft: 8 }}>
          <Slider min={16} max={32} value={size} onChange={handleSizeChange} />
        </div>
        <InputNumber style={{ width: 49, height: 24, marginLeft: 8 }} value={size} />
      </div>
      <Divider style={{ margin: '24px 0px 8px 0px' }} />
      <div className='title'>描边粗细</div>
      <div className='btn'>
        <div style={{ flex: 1, marginTop: 8, marginLeft: 8 }}>
          <Slider disabled={!isLine} min={!isLine ? 0 : 1} max={4} value={!isLine ? 0 : lineWidth} onChange={handleLineChange} />
        </div>
        <InputNumber style={{ width: 49, height: 24, marginLeft: 8 }} value={!isLine ? 0 : lineWidth} />
      </div>
      <Divider style={{ margin: '24px 0px 8px 0px' }} />
      ...
      <Divider style={{ margin: '24px 0px 8px 0px' }} />
      <Button onClick={handleRest} style={{ margin: '0px auto', width: 214, height: 24 }}>清空配置</Button>
    </div>
  )
};
